...
public interface IParkingSessionRepository
{
    ...
    Task<int> CountActiveBySectorAsync(string sectorName, CancellationToken cancellationToken = default);
    ...
    Task<decimal> SumRevenueAsync(string sectorName, DateOnly date, CancellationToken cancellationToken = default);
}
