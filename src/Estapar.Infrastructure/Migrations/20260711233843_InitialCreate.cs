        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Spots_Sectors_SectorName",
                        column: x => x.SectorName,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ParkingSessions_Sectors_SectorName",
                        column: x => x.SectorName,
                        principalTable: "Sectors",
                        principalColumn: "Name",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ParkingSessions_SectorName_ExitTime",
                table: "ParkingSessions",
                columns: new[] { "SectorName", "ExitTime" });
